...
Memoria.shot_events = {
    ...
    challengeDone = "CHALLENGE_MODE_COMPLETED",
    reputationChange = "CHAT_MSG_SYSTEM",
    bosskills = "ENCOUNTER_END",
    levelUp = "PLAYER_LEVEL_UP",
    levelUpShowPlayed = "TIME_PLAYED_MSG",
    arenaEnding = "UPDATE_BATTLEFIELD_STATUS",
    battlegroundEnding = "UPDATE_BATTLEFIELD_STATUS",
}
...
function Memoria:RegisterEvents(frame)
    ...
    for option, event in pairs(Memoria.shot_events) do
        if IsEventValid(event) and Memoria_Options[option] then
